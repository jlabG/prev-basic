window.addEventListener('load', function () {
    ...
    class Angler1 extends Enemy {
        constructor(game) {
            super(game); // parent constructor executed
            this.width = 220 * 0.2;
            this.height = 169 * 0.2;
    ...
    class UI {
        ...
        draw(context) {
            ...
            // context.fillStyle = 'black';  // I added
    ...
    class Game {
        constructor(width, height) {
            ...
            this.maxAmmo = 50;
            this.ammoTimer = 0;
            this.ammoInterval = 500; //replenishment
            this.gameOver = false;
            this.score = 0;
            this.winningScore = 5;
    ...
    function animate(timeStamp) {
        // delta is change from last loop time to this loop timeStamp time
